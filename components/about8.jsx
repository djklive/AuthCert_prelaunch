    ...
    <section className="py-32">
      ...
      <section className="relative container max-w-5xl py-10 md:py-12 lg:py-15">
        <div className="flex items-center justify-between mb-10">
          <Link href="/"><ArrowBigLeftIcon className=" text-gray-500 rounded-full border border-black size-12 p-2" /></Link>
        </div>
        <div className="">
        ...
        <>
          <div
            className="absolute inset-0 z-[-1] -translate-y-1/2 blur-[100px] will-change-transform">
            <div
              className="bg-gradient-1/25 absolute top-0 right-0 h-[400px] w-[800px] -translate-x-1/5 rounded-full" />
            <div
              className="bg-gradient-2/10 absolute top-0 right-0 size-[400px] rounded-full" />
          </div>
          <div
            className="absolute -inset-40 z-[-1] [mask-image:radial-gradient(circle_at_center,black_0%,black_20%,transparent_80%)]">
